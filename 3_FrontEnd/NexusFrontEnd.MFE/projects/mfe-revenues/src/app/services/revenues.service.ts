...
import { Revenue, RevenueCreatePayload, RevenueDetail } from '@shared/core/models/revenue.model';
import { API_RESOURCES, API_SUBROUTES } from '@shared/core/constants/api-endpoints';
...
export class RevenuesService {
  ...
  deleteRevenue(id: number): Observable<any> {
    return this.http.put(`${this.API_URL}/${id}${API_SUBROUTES.anular}`, {});
  }
